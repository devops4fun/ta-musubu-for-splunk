...
import input_module_musubu_api_data as input_module
...
'''
    ...
    Add your modular input logic to file input_module_musubu_api_data.py
'''
class ModInputmusubu_api_data(modinput_wrapper.base_modinput.BaseModInput):
    ...
    def __init__(self):
        ...
        super(ModInputmusubu_api_data, self).__init__("ta_musubu_for_splunk", "musubu_api_data", use_single_instance)
        self.global_checkbox_fields = None

    def get_scheme(self):
        """overloaded splunklib modularinput method"""
        scheme = super(ModInputmusubu_api_data, self).get_scheme()
        scheme.title = ("musubu_api_data")
